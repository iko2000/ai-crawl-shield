...
[![npm version](https://img.shields.io/npm/v/next-ai-shield.svg)](https://www.npmjs.com/package/next-ai-shield)
...
```javascript
const { setup } = require('next-ai-shield');
setup();
```
